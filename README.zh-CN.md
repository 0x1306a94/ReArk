...
- 支持 ABC 解析
- 支持 ABC 反汇编、反编译
- 支持源码结构复原，查看对应源码文件的反汇编、反编译结果
- 支持 ABC 字符串、十六进制内容、格式化 JSON、文本、图片和媒体资源显示
- 提供 ABC 迹索工具，支持 strings、literals、xrefs、调用参数流、ABC tree 检查、源码阅读和反汇编阅读
...
- 动态操纵真机设备，静态分析、签名打包、应用安装、启动验证、追踪日志全流程分析应用

**真机连接**

- 发现连接鸿蒙设备
- 动态安装当前应用到设备
- 截图、检查 UI 节点，并把 UI 线索对应到真实设备状态
...
| 设备运行态 | ABC 迹索视图 |
| --- | --- |
| <img src="assets/screenshots/07-device-runtime.png" alt="HarmonyOS 设备运行态工作区" width="420"> | <img src="assets/screenshots/08-abc-evidance.png" alt="ABC 迹索视图" width="420"> |
